...
# 과일 리스트 중에서 제일 첫 번째 과일은?
print("과일 리스트 중에서 제일 첫 번째 과일은? ", fruits[0])
...
print("내름차순 정렬 : ", fruits)

'''
    리스트를 원하는 모양으로 자르는 슬라이싱
'''
print("과일 리스트 중 2,3,4 번 과일은? ", fruits[1:4]) # 1번지 ~ 4번지 앞까지
print("과일 리스트 중 1 ~ 3 번 과일은? ", fruits[0:3])
print("과일 리스트 중 1 ~ 3 번 과일은? ", fruits[:3])

print("과일 리스트 중 3 번부터 마지막까지 과일은? ", fruits[2:])

print("과일 리스트 중 1,3,5 번 과일은? ", fruits[::2])
